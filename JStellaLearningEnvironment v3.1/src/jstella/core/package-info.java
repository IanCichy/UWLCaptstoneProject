/**
 * 
 *The core elements of the emulator.
 *All of these core elements belong to the JSConsole class, which represents
 *the physical body of the 2600.  A core element that isn't included in this
 *package is the CPU, the 6507 (6502), which is in its own package.
 *
 * <p>
