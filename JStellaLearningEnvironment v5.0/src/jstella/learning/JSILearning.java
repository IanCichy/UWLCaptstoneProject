...
public class JSILearning {
		...
		try{
			...
			for(int x = 0; x < out.getWidth(); x++){
				for(int y = 0; y < out.getHeight(); y++){
					...
					same = true;
					i=0;
					while(i < gameImages.size()-1 && same){
	 ...
	 * @param numFrames the number of frames (must be in the range 1 to 10 inclusive)
	 * @throws IllegalArgumentException if the value is outside of the allowed range
	 */
